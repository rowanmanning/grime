    ...
    var self = {
        ...
        loadFilter: function (name) {
            ...
            if (typeof filter !== 'function') {
                self._log('Filter loading failed: ' + name);
                return false;
            }
            self._log('Filter loaded: ' + name);
        ...
        loadHelper: function (name) {
            ...
            if (typeof helper !== 'function') {
                self._log('Helper loading failed: ' + name);
                return false;
            }
            self._log('Helper loaded: ' + name);
        ...
        loadTemplate: function (name) {
            try {
                ...
                self._log('Template loading failed: ' + name);
                return false;
            }
            self._log('Template loaded: ' + name);
            return true;
        },
